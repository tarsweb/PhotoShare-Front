...
const rules = {
  ...
  angle: [
    v => !!v || 'Angle is required',
  ],
  aspect_ratio: [
    v => !!v || 'Aspect ratio is required',
  ],
  crop: [
    v => !!v || 'Crop is required',
  ],
  background: [
    v => !!v || 'Background is required',
  ],
  width: [
  ...
  border: [
    v => !!v || 'Border is required',
  ],
  gravity: [
    v => !!v || 'Gravity is required',
  ],
  opacity: [
  ...
  transformation: [
    v => !!v || 'Transformation is required',
  ],
  zoom: [
    v => !!v || 'Zoom is required',
  ],
};
